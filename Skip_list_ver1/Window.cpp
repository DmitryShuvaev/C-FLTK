...
Window::Window(int ww, int hh, const string& title)
    :Fl_Double_Window(ww,hh,title.c_str()),w(ww),h(hh),px(390,400,20,20,0)
{
    //px.image(blastb);it doesn't do something here
    init();
}
...
Window::Window(Point xy, int ww, int hh, const string& title)
    :Fl_Double_Window(xy.x,xy.y,ww,hh,title.c_str()),w(ww),h(hh),px(390,400,20,20,0)
{
